...
pip install mypy==1.19.1 pytest==9.0.2 ruff==0.15.7 Flask==3.1.3 Flask_Cors==4.0.0 types-Flask-Cors==6.0.0.20250809 pysqlite3==0.6.0 requests==2.31.0 types-requests==2.32.4.20260107 defusedxml==0.7.1 camel-converter==5.1.0
