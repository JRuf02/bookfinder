...
def test_get_book_with_invalid_isbn(client: FlaskClient) -> None:
    response = client.get("/api/book", query_string={"isbn": "9783458723--4"})
...
def test_get_book_not_in_db(client: FlaskClient) -> None:
    response = client.get("/api/book", query_string={"isbn": "978-3-453-43690-9"})
...
def test_get_book_not_in_db_not_in_dnb(client: FlaskClient) -> None:
    response = client.get("/api/book", query_string={"isbn": "978-1-5266-2658-5"})
