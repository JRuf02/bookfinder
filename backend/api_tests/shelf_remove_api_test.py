...
def test_remove_book_from_missing_shelf(client: FlaskClient) -> None:
    ...
    insert_test_book_into_shelf_in_db(
        app=client.application, osm_id="https://www.openstreetmap.org/node/11935877522"
    )
...
def test_remove_book_from_shelf_other_books_in_shelf(client: FlaskClient) -> None:
...
def test_remove_book_from_shelf_not_containing_book(client: FlaskClient) -> None:
    ...
    insert_test_shelf_into_db(
        client.application, osm_id="https://www.openstreetmap.org/node/3093755951"
    )
